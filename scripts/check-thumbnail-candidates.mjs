...
const failures = [];
const warnings = [];
const allowedSourceKinds = new Set(["approved_restaurant_media", "official_feed_media", "meta_social_media", "official_page_thumbnail_candidate", "public_campaign_menu_image", "public_special_source_image", "directory_source_image"]);
