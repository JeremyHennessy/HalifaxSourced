...
function structuredEventDetailRow(event) {
  ...
  const when = Number.isNaN(start.getTime()) ? "Date unavailable" : start.toLocaleString("en-CA", { weekday: "short", month: "short", day: "numeric", hour: "numeric", minute: "2-digit" });
